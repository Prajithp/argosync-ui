...
func newEnvironment(db *gorm.DB, opts ...gen.DOOption) environment {
	...
	_environment.environmentDo.UseModel(&models.Environment{})
...
type IEnvironmentDo interface {
	...
	Create(values ...*models.Environment) error
	CreateInBatches(values []*models.Environment, batchSize int) error
	Save(values ...*models.Environment) error
	First() (*models.Environment, error)
	Take() (*models.Environment, error)
	Last() (*models.Environment, error)
	Find() ([]*models.Environment, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Environment, err error)
	FindInBatches(result *[]*models.Environment, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.Environment) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.Environment, error)
	FirstOrCreate() (*models.Environment, error)
	FindByPage(offset int, limit int) (result []*models.Environment, count int64, err error)
...
func (e environmentDo) Create(values ...*models.Environment) error {
	if len(values) == 0 {
		return nil
	}
...
func (e environmentDo) CreateInBatches(values []*models.Environment, batchSize int) error {
	return e.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (e environmentDo) Save(values ...*models.Environment) error {
	if len(values) == 0 {
		return nil
	}
...
func (e environmentDo) First() (*models.Environment, error) {
	if result, err := e.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Environment), nil
	}
}

func (e environmentDo) Take() (*models.Environment, error) {
...
func (e environmentDo) Last() (*models.Environment, error) {
...
func (e environmentDo) Find() ([]*models.Environment, error) {
	result, err := e.DO.Find()
	return result.([]*models.Environment), err
}

func (e environmentDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Environment, err error) {
	buf := make([]*models.Environment, 0, batchSize)
...
func (e environmentDo) FindInBatches(result *[]*models.Environment, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (e environmentDo) FirstOrInit() (*models.Environment, error) {
...
func (e environmentDo) FirstOrCreate() (*models.Environment, error) {
...
func (e environmentDo) FindByPage(offset int, limit int) (result []*models.Environment, count int64, err error) {
...
func (e environmentDo) Delete(models ...*models.Environment) (result gen.ResultInfo, err error) {
