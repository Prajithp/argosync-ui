  ...
  const handleRollback = async (deployment: Deployment) => {
    try {
      ...
      await rollbackDeployment(
        ...
        deployment.region,
        undefined, // version is undefined for standard rollback
        "system" // Using default value for rollbacks, could be replaced with a user input
      );
      
      setSuccess(`Successfully rolled back ${deployment.applicationName} in ${deployment.environment} (${deployment.region})`);
